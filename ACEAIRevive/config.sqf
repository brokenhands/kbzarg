...
btc_qr_help_radius = 150; //Check for helpers nearby

btc_qr_time = 0; //time in seconds for revive (0 = no time limit)
btc_qr_show_time = false; //if true it shows time while unc
...
btc_qr_def_spawn = ["respawn_west"]; //Markers names where you want to spawn
btc_qr_cam_dist = 20;
...
btc_qr_fnc_call_for_help = compile preprocessFileLineNumbers "ACEAIRevive\call_for_help.sqf";
//btc_qr_fnc_hd = compile preprocessFileLineNumbers "ACEAIRevive\hd.sqf";
btc_qr_fnc_help = compile preprocessFileLineNumbers "ACEAIRevive\help.sqf";
//btc_qr_fnc_multiple_spawn = compile preprocessFileLineNumbers "ACEAIRevive\multiple_spawn.sqf";
//btc_qr_fnc_resp = compile preprocessFileLineNumbers "ACEAIRevive\resp.sqf";
//btc_qr_fnc_resp_AI = compile preprocessFileLineNumbers "ACEAIRevive\resp_AI.sqf";
//btc_qr_fnc_unc = compile preprocessFileLineNumbers "ACEAIRevive\unc.sqf";
btc_qr_fnc_unit_init = compile preprocessFileLineNumbers "ACEAIRevive\unit_init.sqf";
btc_qr_fnc_var = compile preprocessFileLineNumbers "ACEAIRevive\var.sqf";
